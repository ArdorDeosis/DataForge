...
public static class Grid
{
  ...
  /// <b>Grid Definition</b>
  /// <p>
  ///   The grid's number of dimensions is defined by the length of the <paramref name="size" /> parameter. Every
  ///   value defines the size of the grid in the corresponding dimension. Dimension n's coordinate range is thus
  ///   defined as <tt>[0, size[n] - 1]</tt>.
  /// </p>
  /// </summary>
  /// <param name="size">
  ...
  ///   <tt>[offset[n], size[n] + offset[n] - 1]</tt>.
  /// </p>
  /// </summary>
  /// <param name="size">
  /// The size of the grid in the corresponding dimensions. This also defines the number of dimensions of the grid.
  ...
  ///   creates the topology of a cylinder, wrapping both dimensions creates the topology of a torus etc.)
  /// </p>
  /// </summary>
  /// <param name="size">
  /// The size of the grid in the corresponding dimensions. This also defines the number of dimensions of the grid.
  ...
  ///   a two-dimensional grid creates the topology of a torus etc.)
  /// </p>
  /// </summary>
  /// <param name="size">
  /// The size of the grid in the corresponding dimensions. This also defines the number of dimensions of the grid.
  ...
  /// <b>Grid Definition</b>
  /// <p>
  ///   The grid's number of dimensions is defined by the length of the <paramref name="dimensions" /> parameter. Every
  ...
  ///   Dimension n's coordinate range is thus defined as <tt>[offset[n], size[n] + offset[n] - 1]</tt>.
  /// </p>
  /// </summary>
