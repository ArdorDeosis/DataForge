...
{
  private (ObservableIndexedGraph<int, int, int> graph, int index, IndexedNode<int, int, int> node) SetupSingleNode()
  {
  ...
  private (ObservableIndexedGraph<int, int, int> graph,
    IndexedNode<int, int, int> invalidNode,
    IndexedNode<int, int, int> removedNode) SetupInvalidNodes()
  {
    var graph = new ObservableIndexedGraph<int, int, int>();
    var otherGraph = new ObservableIndexedGraph<int, int, int>();
    const int index = 0xC0FFEE;
