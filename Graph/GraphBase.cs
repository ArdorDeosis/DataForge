...
public abstract class GraphBase<TNodeData, TEdgeData>
{
  ...
  public abstract bool Contains(OldNode<,,> node);

  /// <summary>
  /// Whether the graph contains the provided edge.
  /// </summary>
  /// <param name="edge">The edge to check.</param>
  public abstract bool Contains(OldEdge<,,> edge);

  /// <summary>
  /// All nodes in this graph.
  /// </summary>
  public abstract IEnumerable<OldNode<,,>> Nodes { get; }

  /// <summary>
  /// All edges in this graph.
  /// </summary>
  public abstract IEnumerable<OldEdge<,,>> Edges { get; }
  ...
  protected OldNode<,,> MakeNode(TNodeData data) => new(this, data);
  ...
  /// invalidated.
  /// </exception>
  protected OldEdge<,,> MakeEdge(OldNode<,,> start, OldNode<,,> end,
    TEdgeData data)
  {
    if (!start.IsIn(this))
    ...
    var edge = new OldEdge<,,>(this, start, end, data);
