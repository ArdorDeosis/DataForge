...
internal static partial class TestData
{
  ...
  {
    return from function in FunctionOverloads.CoordinateFunctions()
  ...
  {
    return from function in FunctionOverloads.CoordinateFunctionsWithOffset()
  ...
  {
    return from function in FunctionOverloads.RawCoordinateFunctions()
  ...
  {
    return from function in FunctionOverloads.EdgeInformationFunctions()
  ...
  {
    return from function in FunctionOverloads.EdgeInformationFunctionsWithOffset()
  ...
  {
    return from function in FunctionOverloads.EdgeInformationFunctionsWithWrap()
  ...
  {
    return from function in FunctionOverloads.EdgeInformationFunctionsWithOffsetAndWrap()
  ...
  {
    return from function in FunctionOverloads.RawEdgeInformationFunctions()
