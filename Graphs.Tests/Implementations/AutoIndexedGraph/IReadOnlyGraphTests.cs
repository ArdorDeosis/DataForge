...
public class IReadOnlyGraphTests : IReadOnlyGraphTests<AutoIndexedGraph<int, int, int>>
{
  protected override AutoIndexedGraph<int, int, int> GetEmptyGraph => new(new IncrementalIndexProvider<int, int>(0));

  protected override (AutoIndexedGraph<int, int, int> graph, INode<int, int>[] expectedNodes) GraphWithNodes
  {
    get
    {
  ...
  protected override (AutoIndexedGraph<int, int, int> graph, IEdge<int, int>[] expectedEdges) GraphWithEdges
  {
    get
    {
      var graph = new AutoIndexedGraph<int, int, int>(new IncrementalIndexProvider<int, int>(0));
