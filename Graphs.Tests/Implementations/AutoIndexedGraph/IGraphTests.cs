...
public class IGraphTests : IGraphTests<AutoIndexedGraph<int, int, int>>
{
  ...
  protected override (AutoIndexedGraph<int, int, int> graph, IReadOnlyCollection<INode<int, int>> expectedNodes)
    GraphWithNodes
  {
    get
    {
  ...
  protected override (AutoIndexedGraph<int, int, int> graph, IReadOnlyCollection<IEdge<int, int>> expectedEdges)
    GraphWithEdges
  {
    get
    {
