...
public class IIndexedGraphTests : IIndexedGraphTests<IndexedGraph<int, int, int>>
{
  ...
  protected override (IndexedGraph<int, int, int> graph, IndexedNode<int, int, int> node1, IndexedNode<int, int, int>
  ...
  protected override (IndexedGraph<int, int, int> graph, IndexedEdge<int, int, int> expectedEdge) GraphWithEdge
  {
    get
    {
  ...
  protected override (IndexedGraph<int, int, int> graph, IndexedNode<int, int, int> removedNode)
  ...
  protected override (IndexedGraph<int, int, int> graph, IndexedEdge<int, int, int> removedEdge)
